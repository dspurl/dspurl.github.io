import{_ as e,a as i,b as n,c as s}from"./20240510143752-DZ4A3ttv.js";import{_ as l,o as a,c as d,a as t}from"./app-DGDGLuI8.js";const r={},v=t(`<h1 id="快速上手" tabindex="-1"><a class="header-anchor" href="#快速上手"><span>快速上手</span></a></h1><blockquote><p>环境要求</p></blockquote><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>php &gt;= 7.4
laravel = 7.22.6
mysql &gt;= 5.7
vue = 2.5.17
node= 14.18.3
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="api搭建" tabindex="-1"><a class="header-anchor" href="#api搭建"><span>API搭建</span></a></h2><h3 id="phpstudy" tabindex="-1"><a class="header-anchor" href="#phpstudy"><span>phpstudy</span></a></h3><ol><li>下载项目到phpstudy项目目录，这里假设为d盘下的www目录</li><li>解压项目到www目录下</li><li>打开phpstudy，网站-&gt;创建网站，域名将是后面你访问该项目的域名；根目录选择你的项目地址下的api/public目录；勾选同步hosts，php版本选7.4.3</li></ol><p><img src="`+e+`" alt="图片"> 4. 选择伪静态，复制以下代码</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>location / {
