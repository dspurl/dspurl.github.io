...
<h2 id="api搭建" tabindex="-1"><a class="header-anchor" href="#api搭建"><span>API搭建</span></a></h2>
...
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code># 如果根目录下没有.env文件，请复制.env.dev并重命名为.env,以下为数据库连接信息，修改成自己的数据库信息
DB_HOST=127.0.0.1
DB_PORT=3306
DB_DATABASE=tfshop
DB_USERNAME=root
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="uni-app搭建" tabindex="-1"><a class="header-anchor" href="#uni-app搭建"><span>uni-app搭建</span></a></h2>
<ol>
<li>打开HBuilder X</li>
<li>文件-&gt;导入-&gt;从本地目录导入</li>
<li>选择<code v-pre>dsshop\client\uni-app\mix-mall</code></li>
